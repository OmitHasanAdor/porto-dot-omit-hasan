    ...
    <section className="relative min-h-screen bg-[#050505] flex items-center overflow-hidden pt-24">
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-cyan-500/30 bg-cyan-500/10 text-cyan-400 text-sm mb-5">
            Available For Freelance Work
          </div>

          <div className="text-2xl lg:text-4xl font-semibold text-gray-300 mt-6 h-16">
            <TypeAnimation
              sequence={[
                "Frontend Developer",
                2000,
          ...
          <div className="flex gap-5 mt-8 text-2xl text-gray-400">
            <a href="https://github.com/OmitHasanAdor" target="_blank">
              <FaGithub className="hover:text-cyan-400 transition" />
            </a>

            <a href="https://linkedin.com/in/omit-hasan-ador" target="_blank">
        ...
        >
          <div className="relative">
            ...
            <Image
              ...
              height={500}
              priority
              className="relative z-10 object-cover rounded-3xl border border-cyan-500/30"
            />
          </div>
        </motion.div>
      </div>
